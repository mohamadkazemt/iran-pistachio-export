...
const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    origin: "Eslami Industrial Milling Center",
    hsCode: "1106.30.90",
    minOrder: "500 Kilograms",
  ...
  },
  {
    ...
    origin: "Eslami Cold-Press Laboratory",
    hsCode: "2008.19.20",
    minOrder: "1,000 Jars",
  ...
  },
  {
    ...
    unit: "Industrial Bag",
    imageUrl: "https://images.unsplash.com/photo-1517093602195-b40af9688b46?auto=format&fit=crop&w=600&q=80",
    origin: "Eslami Technical Fab Center",
    hsCode: "3923.21.00",
...
const INITIAL_BLOGS: Blog[] = [
  ...
  },
  {
    ...
    content: "## Introduction\nScientific literature demonstrates that premium grade nuts contain a superior concentration of bioactive lipids. In particular, green pistachio kernels and Long Mamra almonds are highly enriched in oleic acid and omega-nine fatty acids, which actively support healthy blood lipid levels.\n\n## 1. Lipid Stability & Oxidation Mitigation\nTree nuts oils are sensitive to UV exposure and high room temperatures. Eslami cold-gas milling and nitrogen vacuum packing keeps relative oxidation near zero, ensuring active enzymes stay stable for up to 24 months.\n\n## 2. ISO 3632 & Heavy Metal Controls\nImporters must request full lab reports ensuring heavy metals (like Lead and Cadmium) and mycotoxins are well below FDA and EFSA limits. All Eslami products are certified organic, showing non-detectable traces across full-grid spectrum tests.",
...
const INITIAL_SETTINGS: SiteSettings = {
  brandName: "Eslami Global Trading",
  logoText: "Aura",
  logoSubtext: "Lux",
  phone: "+98 21 8888 1234",
  whatsApp: "+971 50 123 4567",
  telegram: "auralux_global",
  email: "procurement@eslami-global.com",
  ...
  homepageTexts: {
    en: {
      ...
      heroDesc: "Eslami facilities orchestrate an elite organic pipeline of premium Persian raw pistachios, exclusive tree nuts, and delicate dried fruit reserves. Sourced from dry high-altitude volcanic soils, certified under absolute ISO validation systems, and loaded to global freight corridors securely.",
    ...
    es: {
      ...
      heroDesc: "Eslami organiza una cadena de suministro orgánica de élite para pistachos persas de primera calidad y delicias botánicas exclusivas. Cultivados en campos ancestrales y auditados bajo normas de certificación ISO.",
    ...
    zh: {
      ...
      heroTitle1: "原生卓越纯度,",
      heroTitle2: "主权安全物流",
      heroDesc: "Eslami 致力于构建全球顶奢有机开心果、精品坚果及精品干果类天然农产品的全球出口通道。来自富含矿物质高海拔古老产区，历经严苛的 ISO 权威质检与无缝全球干线货运衔接。",
      ctaCatalog: "查看皇家专属储备",
      ctaAdvisor: "阿乌拉智慧合规台",
      stat1Label: "实测科学纯度标准",
      stat1Value: "99.8% 合格率",
    ...
    ar: {
      ...
      heroDesc: "تنسق Eslami سلسلة إمداد عضوية نخبوية للفستق الفارسي الفاخر والمكسرات الحصرية والفاكهة المجففة الفاخرة. يتم حصادها من حقول قديمة وتوثيقها بموجب أنظمة شهادات ISO الحازمة للمنافذ الدولية.",
    ...
    de: {
      ...
      heroDesc: "Eslami koordiniert eine Premium-Bio-Pipeline für erlesene iranische Pistazienkerne, exklusive Baumnüsse und getrocknete Früchte. Direkt bezogen von jahrhundertealten Plantagen und zertifiziert nach ISO-Standards.",
    ...
    fa: {
      ...
      heroDesc: "تجهیزات مدرن و شبکه تأمین Eslami زنجیره‌ای مقتدر از صادرات پسته ممتاز اکبری، بادام، گردو و میوه‌های خشک دست‌چین را سازماندهی می‌کند. این سبد نفیس حاصل خاک‌های حاصلخیز مرتفع اراضی آتشفشانی، با گواهی‌نامه‌های معتبر ISO و بسته‌بندی‌های خلأ پیشرفته است.",
  ...
  videos: [
    {
      id: "vid-1",
      title: "Eslami Corporate Sourcing Documentary",
  ...
  private seedDemoData() {
    ...
    if (!this.data.settings.seo) {
      this.data.settings.seo = {
        metaTitle: "Eslami Global Trading | Premium Persian Organic Pistachios & Sourcing Solutions",
        metaDescription: "Eslami facilities orchestrate an elite organic pipeline of premium Persian raw pistachios, exclusive tree nuts, and delicate dried fruit reserves. Sourced from dry volcanic soils, certified under absolute ISO validation systems.",
